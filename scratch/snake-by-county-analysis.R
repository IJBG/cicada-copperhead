...
# DEPRECIATED - counties are not a real unit of measurement that matters, useful for determining what counties ought to be included in a cicada analysis, but not for actually calculating how cicada presence changes the number of copperheads seen.
#--------------------------
