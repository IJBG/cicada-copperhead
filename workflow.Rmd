...
Looking at the graphs both grouped (boxplot) and with each brood broken out seperately (ggplot), there's no affect either during the emergence window the year of vs year before or during the whole year year of year before, weather or not you account for the presence of counties where copperheads ought to be present but have never been recorded on iNat.